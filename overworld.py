...
class Icon(pygame.sprite.Sprite):
    def __init__(self, pos):
        super().__init__()
        out = pygame.image.load('./graphics/overworld/move.png').convert_alpha()
        self.image = pygame.transform.scale(out, (64, 64))
        self.pos = pos
        self.rect = self.image.get_rect(center=pos)
...
class Overworld:
    ...
    def draw_bg(self):
        bg = pygame.image.load("background-1.png").convert_alpha()
        im = pygame.transform.scale(bg, (screen_width, screen_height))
